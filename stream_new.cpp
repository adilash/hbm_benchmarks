...
#ifndef STREAM_ARRAY_SIZE2
#   define STREAM_ARRAY_SIZE2	268435456
#endif
...
static double	bytes[4] = {
    2 * sizeof(STREAM_TYPE) * STREAM_ARRAY_SIZE2,
    2 * sizeof(STREAM_TYPE) * STREAM_ARRAY_SIZE2,
    3 * sizeof(STREAM_TYPE) * STREAM_ARRAY_SIZE2,
    3 * sizeof(STREAM_TYPE) * STREAM_ARRAY_SIZE2
    };
...
void *ptr =
  ...
  STREAM_TYPE *f=(STREAM_TYPE *)ptr;
  STREAM_TYPE *g=(STREAM_TYPE *) ((char *)ptr + SLAB_SZ_1GB*2llu);
  STREAM_TYPE *h=(STREAM_TYPE *) ((char *)ptr + SLAB_SZ_1GB*4llu);
